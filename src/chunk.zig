...
pub const Chunk = struct {
    ...
    pub fn disassembleInstruction(self: *Chunk, offset: usize) usize {
        ...
        switch (@as(OpCode, @enumFromInt(self.code.items[offset]))) {
            ...
            .GetLocal => return byteInstruction(self, "OP_GET_LOCAL", offset),
            .SetLocal => return byteInstruction(self, "OP_SET_LOCAL", offset),
            ...
            .InstanceInit => return twoByteInstruction(self, "OP_INSTANCE_INIT", offset),
            .IndexGet => return simpleInstruction("OP_INDEX_GET", offset),
            .IndexSet => return simpleInstruction("OP_INDEX_SET", offset),

            .FieldGetByIndex => return byteInstruction("OP_FIELD_GET_BY_INDEX", offset),
            .FieldSetByIndex => return byteInstruction("OP_FIELD_SET_BY_INDEX", offset),
            .FieldGetByName => return constantInstruction("OP_FIELD_GET_BY_NAME", offset),
            .FieldSetByName => return constantInstruction("OP_FIELD_SET_BY_NAME", offset),
